        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
          ...
          <div>
            ...
            <div class="mt-1 flex items-center">
              ...
              <span v-else class="flex justify-center items-center h-12 w-12 rounded-full overflow-hidden bg-gray-100">
              ...
              <button type="button" class="relative overflow-hidden ml-5 bg-white py-2 px-3 border-gray-300 border
          ...
          <div>
            ...
            <div class="mt-1">
              ...
              autocomplete="survey_description" placeholder="Describe your survey" class="
              shadow-sm focus:border-indigo-500 focus:border-indigo-500 mt-1 block w-full
