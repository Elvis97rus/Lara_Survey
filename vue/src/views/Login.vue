<template>
      ...
      <form class="mt-8 space-y-6" @submit="login">
        <div v-if="errorMsg" class="py-3 px-5 bg-red-500 text-white rounded flex justify-between items-center">
          {{ errorMsg }}
          <span @click="errorMsg = ''" class="px-2 text-3xl flex items-center justify-center rounded-full transition-colors cursor-pointer hover:bg-[rgba(0,0,0,0.2)]">&times;</span>
        </div>
